...
def m2mPnl(fname):
    ...
    [_d, _t, _m, bidQty, bidPrice, _1, _2] = tob[(tob.bidQty > 0)].values[-1]
    [_d, _t, _m, _1, _2, askPrice, askQty] = tob[(tob.askQty > 0)].values[-1]
...
if __name__ == '__main__':
    ...
    print()
    m2mPnl("/home/jc/CLionProjects/hft/data/latencyRaceOutput1_1.csv")
    print()
    print()
    print("---------------- Latency 1ns 20ns ------------------------")
    print()
    m2mPnl("/home/jc/CLionProjects/hft/data/latencyRaceOutput1_20.csv")
